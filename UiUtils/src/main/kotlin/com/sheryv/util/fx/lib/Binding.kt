...
fun <T, N> ObservableValue<T>.select(nested: (T) -> Property<N>): Property<N> {
  return EasyBind.monadic(this).selectProperty(nested)
}

fun <T, N> ObservableValue<T>.toList(nested: (T) -> List<N>?): ObservableList<N> {
