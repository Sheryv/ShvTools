...
//    }
    ...
    static {
        ...
        map.put("com.sheryv.utils.logging.ShFormatter.format", "%t %L %n: %m");
        map.put("com.sheryv.utils.logging.ShFormatter.colorize", "true");
        map.put("com.sheryv.utils.logging.ShFormatter.date.format", "yyyy-MM-dd HH:mm:ss.SSS");
        map.put("handlers", "java.util.logging.ConsoleHandler");
        map.put("java.util.logging.ConsoleHandler.formatter", "com.sheryv.utils.logging.ShFormatter");
        map.put(".level", "FINEST");
        map.put("java.util.logging.ConsoleHandler", "FINEST");
        map.put("java.util.logging.FileHandler.formatter", "com.sheryv.utils.logging.ShFormatter");
