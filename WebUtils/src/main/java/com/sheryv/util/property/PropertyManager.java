...
public class PropertyManager {
  ...
  public Optional<String> byKeyAsString(@NotNull String key) {
  ...
  public <T> Optional<T> byKey(@NotNull String key) {
    Object value = others.get(key);
    if (value == null)
      return Optional.empty();
    try {
  ...
  public <T extends PropertyGroup> Optional<T> byId(@NotNull String id) {
