...
import com.sheryv.tools.websitescraper.view.settings.TableSettingsRow
...
object ViewUtils {
  ...
  fun tableDragabbleRowFactory(): Callback<TableView<TableSettingsRow.RowDefinition>, TableRow<TableSettingsRow.RowDefinition>> {
