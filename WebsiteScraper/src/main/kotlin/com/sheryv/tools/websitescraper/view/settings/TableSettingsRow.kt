...
class TableSettingsRow(name: String, val items: List<RowDefinition>, val columns: List<String> = emptyList()) :
  ...
  override fun buildPart(): Region {
    ...
    table.rowFactory = ViewUtils.tableDragabbleRowFactory()
  ...
  data class RowDefinition(val cells: List<String>, val enabled: Boolean = true) {
