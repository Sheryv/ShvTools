...
open class SeleniumDriver(
  ...
  protected lateinit var scraper: Scraper<SeleniumDriver>
  ...
  override fun initialize(scraper: Scraper<out SDriver>) {
    this.scraper = scraper as Scraper<SeleniumDriver>
  }
  ...
  override fun get(url: String) {
    if (url.startsWith("http:") || url.startsWith("https:")) {
      ...
      var merged = scraper.def.websiteUrl.trimEnd('/') + "/" + url.trimStart('/')
